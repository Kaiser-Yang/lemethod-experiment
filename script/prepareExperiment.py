...
def condaActivate(workerNum: int, envName: str = "lemethod") -> None:
    for i in range(workerNum):
        execCmd(getWorkerName(i), f'bash -c "echo \'conda activate {envName}\' >> /root/.bashrc"')
    execCmd("server", f'bash -c "echo \'conda activate {envName}\' >> /root/.bashrc"')
