...
# Usage: python experiment.py WORKER_NUM MODULE_SIZE ITERATION SLEEP_AFTER_PULL
...
if __name__ == '__main__':
    argc = len(sys.argv)
    if argc != 5:
        print('Usage: python experiment.py WORKER_NUM MODULE_SIZE ITERATION SLEEP_AFTER_PULL')
        exit(1)
    else:
