...
#              res = execCmd(nodeName, "cat /root/calculationTimeFile.txt")
#              print(res[nodeName]["cat /root/calculationTimeFile.txt"]["output"])
#              with open(savePath + "/" + nodeName + "CalculationTimeFile.txt", "w") as resFile:
#                  resFile.write(res[nodeName]["cat /root/calculationTimeFile.txt"]["output"])
