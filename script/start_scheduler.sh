...
# Uusage: bash start_scheduler.sh NUM_WORKER ENABLE_LEMETHOD ENABLE_TSENGINE LEMETHOD_CONNECTION_TYPE
...
# start scheduler
export START_SCHEDULER='/root/miniconda3/envs/lemethod/bin/python '$SCHEDULER_PATH
DMLC_ROLE=scheduler \
