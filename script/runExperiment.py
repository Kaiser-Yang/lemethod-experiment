...
# NOTE: SCHEDULE_NUM is how many workers will join one scheduling for lemethod.
#       CONNECTION_TYPE: 0 means star, 1 means fully connected, 2 means use
#       lemethod_config to specify. When VERBOSE is -1, the process will print logs.
