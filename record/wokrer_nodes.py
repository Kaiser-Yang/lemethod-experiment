...
plt.title('Static scenario: total time vs number of workers', fontsize=14)
...
plt.xlabel('Number of worker nodes', fontsize=12)
plt.ylabel('Total time (s)', fontsize=12)
plt.title('Dynamic scenario: total time vs number of workers', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.6)
plt.legend(fontsize=10)
plt.tight_layout()
...
plt.title('总耗时随工作节点数量变化图（模型大小240MB）', fontsize=14)
plt.grid(True, linestyle='--', alpha=0.6)
plt.legend(fontsize=10)
plt.tight_layout()
